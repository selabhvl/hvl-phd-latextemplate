...
% Part Style Setup
\DeclareRobustCommand{\spaceduppercaps}[1]{\textls[30]{\scshape\MakeTextUppercase{#1}}}
...
\titleformat*{\subsection}{\fontsize{16}{19.2}\selectfont\itshape\bfseries}
\titleformat*{\subsubsection}{\fontsize{14}{16.8}\selectfont\itshape\bfseries}
