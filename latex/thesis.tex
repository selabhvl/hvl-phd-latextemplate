...
ISBN: XXXXXX\vspace{3ex} (print) % number has to be decided by the library of the university
ISBN: XXXXXX\vspace{3ex} (digital) % number has to be decided by the library of the university
