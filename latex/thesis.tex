...
\ifcompileiliad
	...
	\usepackage[papersize={122mm,160mm},
				...
				dvips]
				{geometry}
\else % Default regular A4, based on setting file 
...
%(default is 13pt based on UiB standard in setting file)
\ifDownscaledFinalDoc
	\fontsize{\TextSize}{\BaseLineSkip}
	\selectfont
\fi

%Double line spacing for draft (default is false in setting file)
\ifDraft              
	\doublespacing   
\fi
